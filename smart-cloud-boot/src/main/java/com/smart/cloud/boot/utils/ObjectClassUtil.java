...
/**
 * @className: com.smart.cloud.boot.utils.ObjectClassUtil
 * @title: 封装SmartCloud项目-ObjectClassUtil类
 * @description: <p>
 *         SmartCloud项目-ObjectClassUtil
 *         </p>
 * @content: ObjectClassUtil
 * @author: Powered by marklin
 * @datetime: 2023-04-30 22:08
 * @version: 1.0.0
