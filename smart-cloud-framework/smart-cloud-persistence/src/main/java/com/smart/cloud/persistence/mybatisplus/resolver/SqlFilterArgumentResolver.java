package com.smart.cloud.persistence.mybatisplus.resolver;
...
/**
 * @className: com.smart.cloud.persistence.mybatisplus.resolver.SqlFilterArgumentResolver
 * @title: 封装SmartCloud项目-SqlFilterArgumentResolver类
 * @description: <p>
 *         SmartCloud项目-SqlFilterArgumentResolver
 *         </p>
 * @content: SqlFilterArgumentResolver
 * @author: Powered by marklin
 * @datetime: 2023-05-16 23:50
 * @version: 1.0.0
    ...
    public Object resolveArgument(MethodParameter parameter, ModelAndViewContainer mavContainer,
        ...
        if (StrUtil.isNotBlank(current)) {
            ...
            if (CompareUtil.compare(Long.parseLong(current), 0L) < 0) {
                throw new ApplicationException("current page error");
            }
